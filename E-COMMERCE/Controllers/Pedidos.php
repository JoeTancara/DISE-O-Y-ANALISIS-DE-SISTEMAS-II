...
class Pedidos extends Controllers{
	...
	public function Pedidos()
	{
		...
		$data['page_title'] = "PEDIDOS <small>TECHNOLOGICAL WOLRD</small>";
	...
	public function orden($idpedido){
		...
		$data['page_tag'] = "Pedido - TECHNOLOGICAL WOLRD";
		$data['page_title'] = "PEDIDO <small>TECHNOLOGICAL WOLRD</small>";
	...
	public function transaccion($transaccion){
		...
		$data['page_tag'] = "Detalles de la transacción - TECHNOLOGICAL WOLRD";
